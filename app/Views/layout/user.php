...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/css/plugins/extensions/noui-slider.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/css/core/colors/palette-noui.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/css/pages/ecommerce-shop.css">
  ...
  <body class="vertical-layout vertical-menu-modern content-detached-left-sidebar   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="content-detached-left-sidebar">
              ...
              <ul class="nav navbar-nav float-right">
                <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i><span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">5</span></a>
                  <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    <li class="scrollable-contxainer media-list w-100"><a href="javascript:void(0)">
                        <div class="media">
                          <div class="media-left align-self-center"><i class="ft-plus-square icon-bg-circle bg-cyan"></i></div>
                          <div class="media-body">
                            <h6 class="media-heading">Pesanan Baru</h6>
                            <p class="notification-text font-small-3 text-muted">Rena Baru Saja Mebeli...</p><small>
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <h6 class="media-heading red darken-1">Rena Mengirim Pesan</h6>
                            <p class="notification-text font-small-3 text-muted">Lihat Pesan</p><small>
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <h6 class="media-heading yellow darken-3">Stok Tinggal Sediki</h6>
                            <p class="notification-text font-small-3 text-muted">Vestibulum auctor dapibus neque.</p><small>
                              <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">Today</time></small>
                          </div>
                    <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center" href="javascript:void(0)">Baca Semua Notifikasi</a></li>
                  </ul>
                </li>
                <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail">             </i></a>
                  <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    <li class="dropdown-menu-header">
                      <h6 class="dropdown-header m-0"><span class="grey darken-2">Pesan</span></h6><span class="notification-tag badge badge-default badge-warning float-right m-0">4 New</span>
                    </li>
                ...
                <ul class="nav navbar-nav float-right">
                  <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"></span><span class="avatar avatar-online"><img src="<?= base_url() ?>app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></a>
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="<?= site_url('/profil') ?>"><i class="ft-user"></i> Profil</a>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" nav-item"><a href="<?= base_url('beranda') ?>" class="nav-link <?php if (current_url(true)->getPath() == '/index.php/beranda') : ?>active<?php endif; ?>"> 
             <i class="la la-home"></i><span class="menu-title" data-i18n="">Beranda</span></a>
          </li>
          ...
          <li class="nav-item"><a href="<?= base_url('produk') ?>" class="nav-link <?php if (current_url(true)->getPath() == '/index.php/produk') : ?>active<?php endif; ?>">
            <i class="la la-list"></i><span class="menu-title" data-i18n="">Produk</span></a>
          </li>
          <li class=" nav-item"><a href="<?= base_url('keranjang') ?>"class="nav-link <?php if (current_url(true)->getPath() == '/index.php/keranjang') : ?>active<?php endif; ?>">
            <i class="la la-shopping-cart"></i><span class="menu-title" data-i18n="">Keranjang</span></a>
          </li>
          <li class="nav-item"><a href="<?= base_url('pesanan') ?>" class="nav-link <?php if (current_url(true)->getPath() == '/index.php/pesanan') : ?>active<?php endif; ?>">
            <i class="la la-credit-card"></i><span class="menu-title" data-i18n="">Pesanan Anda</span></a>
          </li>
              <!-- <li><a class="menu-item" href="<?= base_url('kategori') ?>" data-i18n="nav.invoice.invoice_template">Wanita</a>
              </li> -->
          </li>
        </ul>
        </ul>
    ...
    <script src="<?= base_url() ?>app-assets/vendors/js/extensions/jquery.cookie.js"></script>
    <script src="<?= base_url() ?>app-assets/vendors/js/extensions/jquery.treeview.js"></script>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.bundle.min.js"></script>
    <!-- END MODERN JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?= base_url() ?>app-assets/js/scripts/pages/content-sidebar.js"></script>
    <script src="<?= base_url() ?>app-assets/js/scripts/pages/ecommerce-product-shop.js"></script>
